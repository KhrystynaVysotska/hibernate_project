...
public class BankEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (identificationCode != null ? !identificationCode.equals(that.identificationCode) : that.identificationCode != null)
            return false;
        if (stateRegistrationCode != null ? !stateRegistrationCode.equals(that.stateRegistrationCode) : that.stateRegistrationCode != null)
            return false;
        if (fullBankName != null ? !fullBankName.equals(that.fullBankName) : that.fullBankName != null) return false;
        if (shortBankName != null ? !shortBankName.equals(that.shortBankName) : that.shortBankName != null)
            return false;
        if (bankLicenseNumber != null ? !bankLicenseNumber.equals(that.bankLicenseNumber) : that.bankLicenseNumber != null)
            return false;
