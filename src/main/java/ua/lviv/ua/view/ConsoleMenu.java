...
public class ConsoleMenu {
	...
	private Map<String, ua.lviv.ua.controller.AbstractController> controllers;
	...
	public void openSubMenu(String key) {
		...
		for (Entry<String, String> entry : menu.entrySet()) {
			if (entry.getKey().length() != 1 && entry.getKey().substring(0, 1).equals(key)) {
				System.out.println(menu.get(entry.getKey()));
			}
		}
	}
